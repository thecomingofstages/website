...
export const GettingToKnowUsSection = () => {
  ...
  return (
    <div id="know-us">
      <Section
        ref={rootRef}
        className="scroll-mt-10 flex flex-col flex-grow gap-6"
      >
        ...
        <div
          ref={scrollRef}
          className="flex-1 overflow-scroll h-full max-h-[70vh] relative"
        >
          <DetailSection title={"Who?"}>
            <Desc>
              พวกเราคือกลุ่มเยาวชนไทยที่เล็งเห็นถึงความเป็นไปได้ในการต่อยอด
              เเละพัฒนาความสามารถของเยาวชนรุ่นใหม่
              โดยเกิดจากการร่วมมือของนักเรียน นักศึกษา จากหลากหลายสถาบัน
